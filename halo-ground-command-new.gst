...
<gameSystem id="sys-6399-a82f-f411-a347" name="halo-ground-command-new" battleScribeVersion="2.03" revision="1" type="gameSystem" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <categoryEntries>
    <categoryEntry name="Force Commander" id="1d19-aba0-3ac5-ad1e" hidden="false"/>
    <categoryEntry name="Standard Battle Groups" id="2622-52fa-29f7-96bb" hidden="false"/>
    <categoryEntry name="Specialist Battle Groups" id="7172-8a4b-611a-9f2c" hidden="false"/>
    <categoryEntry name="Character Units" id="a1111111-1111-1111-1111-111111111111" hidden="false"/>
    <categoryEntry name="Infantry Units" id="870a-81aa-e07c-3d01" hidden="false"/>
    <categoryEntry name="Armoured Units" id="0744-a0c8-3431-ff6e" hidden="false"/>
    <categoryEntry name="Flyer Units" id="7c35-1431-7aeb-f459" hidden="false"/>
  </categoryEntries>
  <forceEntries>
    <forceEntry name="Battle Group Selection" id="8f40-a247-04c7-df36" hidden="false">
      <categoryLinks>
        <categoryLink name="Force Commander" hidden="false" id="8f40-a247-04c7-df36-1d19-aba0-3ac5-ad1e" targetId="1d19-aba0-3ac5-ad1e">
          <constraints>
        ...
        <categoryLink name="Standard Battle Groups" hidden="false" id="8f40-a247-04c7-df36-2622-52fa-29f7-96bb" targetId="2622-52fa-29f7-96bb">
          <constraints>
        ...
        <categoryLink name="Specialist Battle Groups" hidden="false" id="8f40-a247-04c7-df36-7172-8a4b-611a-9f2c" targetId="7172-8a4b-611a-9f2c">
          <modifiers>
