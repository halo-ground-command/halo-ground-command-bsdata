...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" battleScribeVersion="2.01" id="6631-3ba7-47d8-b3df" name="Halo Ground Command" revision="1" type="gameSystem">
  <categoryEntries>
    ...
    <categoryEntry id="870a-81aa-e07c-3d01" name="5. Infantry Units" hidden="false"/>
    <categoryEntry id="0744-a0c8-3431-ff6e" name="6. Armoured Units" hidden="false"/>
    <categoryEntry id="7c35-1431-7aeb-f459" name="7. Flyer Units" hidden="false"/>
  ...
  <costTypes>
    ...
    <costType id="Character" name="CHA" defaultCostLimit="0"/>
  </costTypes>
  <profileTypes>
